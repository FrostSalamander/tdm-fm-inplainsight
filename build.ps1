...
remove-item -path $stagingMissionDir -include .git,savegames,.gitignore,build.ps1,changelog.txt,consolehistory.dat,dmx.darkradiant,dmx.bak,dmx.darkradiant.bak,dmx.xd.bkup,story.md -Force -Recurse
